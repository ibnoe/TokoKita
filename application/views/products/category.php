<div class="crumb_nav">
    <a href="<?php echo base_url(); ?>">home</a> &gt;&gt; <?php echo $category['name'] ?>
</div>
<div class="title"><span class="title_icon"><img src="<?php echo base_url() ?>public/front/images/bullet1.gif" alt="" title="" /></span><?php echo $category['name'] ?></div>
